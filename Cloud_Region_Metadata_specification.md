...
- **24x7 vs. Hourly vs. Annual** — Some provider metrics use a 24-hour hourly energy matching scheme and report data based on an **hourly** weighted average, labelled hourly (rather than 24x7). Other metrics are generated based on annual averages and labelled **annual**.
